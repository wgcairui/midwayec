      ...
      <el-form :model="serial" label-width="80px">
        ...
        <el-form-item label="波特率:">
          <el-select v-model="serial.baudRate">
            <el-option v-for="rate in selects.baudRate" :key="rate" :value="rate"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="数据位:">
          <el-select v-model="serial.dataBits">
            <el-option v-for="bit in selects.dataBits" :key="bit" :value="bit"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="停止位:">
          <el-select v-model="serial.stopBits">
            <el-option v-for="bit in selects.stopBits" :key="bit" :value="bit"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="校验位:">
          <el-select v-model="serial.parity">
            <el-option v-for="party in selects.parity" :key="party" :value="party" :label="party"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
          <el-button size="samll" @click="addSerialports" type="primary">提交</el-button>
        </el-form-item>
      </el-form>
    </el-card>
